...
const testimonials = [
    ...
    },
    {
        id: 2,
        image: './review_2.png',
        description: 'Tortor vel nunc netus pharetra enim, enim dolor mauris in. Sit nam fringilla in egestas. Libero con',
        rating: 4.5,
    ...
    },
    {
        id: 3,
        image: './review_3.png',
        description: 'Tortor vel nunc netus pharetra enim, enim dolor mauris in. Sit nam fringilla in egestas. ',
        rating: 5,
