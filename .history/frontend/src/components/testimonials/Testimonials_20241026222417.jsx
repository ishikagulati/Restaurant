...
const testimonials = [
    ...
    },
    {
        id: 3,
        image: './review_3.png',
        description: 'Loved the unique twist on classic dishes here! The service was quick, and the portions were generous. Only minor downside was the wait time, but it was well worth it for the quality of the meal. Highly recommend the chef's specials!',
        rating: 5,
