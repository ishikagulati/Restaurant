      ...
      <section className="about" id="about">
        <div className="container">
          <div className="banner">
            ...
            <p className="mid">
            Welcome to KC Restaurant, where we bring you an unforgettable dining experience rooted in passion, flavor, and hospitality. Nestled in the heart of , our restaurant is dedicated to serving dishes crafted from fresh, locally-sourced ingredients and inspired by the rich culinary traditions of [Cuisine Type, e.g., Italian, Japanese, Fusion].
